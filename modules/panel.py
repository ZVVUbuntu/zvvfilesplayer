...
class Panel(QWidget):
	...
	#hbox_path
		...
		self.combobox_path_history.setFixedHeight(35)
		...
		self.search_filter_line.setPlaceholderText("filter by name")
		self.search_filter_line.setClearButtonEnabled(True)
		self.search_filter_line.setFixedSize(200, 35)
		...
		self.button_config.set_info(icon=':/config_icon.png')
		self.hbox_path.addWidget(self.button_config)
		#menu_config
		self.menu_config = QMenu()
		self.button_config.setMenu(self.menu_config)
		self.action_treeview_mode = QAction()
		self.action_treeview_mode.setCheckable(True)
		self.action_treeview_mode.setText('TreeView mode')
		self.action_treeview_mode.toggled.connect(self.change_treeview_mode)
		self.menu_config.addAction(self.action_treeview_mode)
